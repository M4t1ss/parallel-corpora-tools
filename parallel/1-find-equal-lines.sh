...
# This one is slower but works better - removes sentences that appear identical on both - source and target sides, but not necessarily parallel to each other
php filter-text.php $1 $2 $1.equal.txt